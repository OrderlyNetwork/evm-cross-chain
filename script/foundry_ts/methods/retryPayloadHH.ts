...
export function retryPayloadHHWithArgv(argv: any) {
    ...
    retryPayloadHH(argv.network, argv.data, argv.env, argv.broadcast, argv.simulate);
}

export function retryPayloadHH(network: string, data: string, env: string, broadcast: boolean, simulate: boolean) {
