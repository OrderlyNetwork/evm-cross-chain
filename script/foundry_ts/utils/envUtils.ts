...
export function getRpcUrl(network: string): string {
    return process.env[network.toUpperCase() + "_RPC_URL"] as string;
}
...
export function getPk(env: string): string {
    return process.env[env.toUpperCase() + "_PRIVATE_KEY"] as string;
}
