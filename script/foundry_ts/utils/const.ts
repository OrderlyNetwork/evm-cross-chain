...
export const CC_RELAY_PROXY_CONTRACT_PATH = "contracts/OrderlyProxy.sol";
...
export const CC_MANAGER_PROXY_CONTRACT_PATH = "contracts/OrderlyProxy.sol";
