...
// Path: script/foundry_scripts/relay/setEndpoint.s.sol
...
// current file name
const method_name = "setEndpoint";

export function setEndpointWithArgv(argv: any) {
    const required_flags = ["env", "network"];
    checkArgs(method_name, argv, required_flags);
    setEndpoint(argv.env, argv.network, argv.broadcast, argv.simulate);
}

export function setEndpoint(env: string, network: string, broadcast: boolean, simulate: boolean) {
...
addOperation(method_name, setEndpointWithArgv);
