...
if (argv.role === undefined) {
    console.error(`Usage: ts-node foundry_ts/genCode.ts --sol <path_to_foundry_script> --role <role>`);
    process.exit(1);
}
...
// output dir
const outDir = argv.role === "manager" ? "foundry_ts/methods/ccmanager" : "foundry_ts/methods/relay";
...
const indexFile = argv.role === "manager" ? "foundry_ts/methods/ccmanager/index.ts" : "foundry_ts/methods/relay/index.ts";
